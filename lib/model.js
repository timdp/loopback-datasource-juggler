...
var ZENTRICK_ID_POOL = 'abcdefghijklmnopqrstuvwxyz0123456789';

var ZENTRICK_ID_LENGTH = 8;
    ...
    if (applyDefaultValues && propVal === undefined) {
      ...
      switch (defn) {
        ...
        case 'now':
          ...
          break;
        case 'zentrickid':
          propVal = chance.string({length: ZENTRICK_ID_LENGTH, pool: ZENTRICK_ID_POOL});
          break;
        default:
